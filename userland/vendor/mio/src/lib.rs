...
// NONOS reaches the os::fd table seam to translate a RawFd into a
// net.sockets handle; that std API is unstable.
#![cfg_attr(target_vendor = "nonos", feature(nonos_fd_seam))]
