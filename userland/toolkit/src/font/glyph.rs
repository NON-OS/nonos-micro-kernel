...
const GLYPH_CHECK: GlyphBitmap =
    GlyphBitmap::new([0x00, 0x01, 0x02, 0x04, 0x88, 0x50, 0x20, 0x00]);
const GLYPH_CROSS: GlyphBitmap =
    GlyphBitmap::new([0x00, 0x82, 0x44, 0x28, 0x10, 0x28, 0x44, 0x82]);
