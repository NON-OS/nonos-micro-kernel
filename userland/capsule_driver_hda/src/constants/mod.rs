...
pub use regs::{
    ...
    SDSTS_BCIS, SD_BDPL, SD_BDPU, SD_CBL, SD_CTL, SD_FMT, SD_LVI, SD_STS, STREAM_FMT_48K16S,
    STREAM_TAG, VERB_SET_AMP_GAIN_MUTE, VERB_SET_CHANNEL_STREAMID, VERB_SET_PIN_WIDGET_CONTROL,
    VERB_SET_POWER_STATE, VERB_SET_STREAM_FORMAT,
};
