...
/// Size and whether it is a directory, or nothing when the path is absent.
pub fn look(owner: u32, full: &[u8]) -> Option<(u64, bool)> {
    match stat_full(owner, full) {
...
pub fn newfstatat(guest: &mut Guest, dirfd: u64, path_ptr: u64, out: u64) -> u64 {
    ...
    match look(mk_getpid() as u32, &full) {
