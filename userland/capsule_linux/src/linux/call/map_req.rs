...
//!
//! The Linux call takes six arguments and passing them onward one at a
//! time makes every function that touches them wider than it should be.
//! They travel together because they are one request.
