...
//! answered with a success status. Every short or failed reply becomes None so
//! callers never read a half-formed buffer.

use alloc::vec::Vec;

use nonos_libc::mk_ipc_call_timeout;

use super::constants::{HDR_LEN, TIMEOUT_MS, VFS_PORT};
