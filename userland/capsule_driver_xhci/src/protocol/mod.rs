...
pub use limits::{
    ...
    ALLOC_TRANSFER_RING_REQUEST_LEN, CONTROLLER_STATUS_PAYLOAD_LEN,
    CONFIG_DESCRIPTOR_REPLY_PREFIX, CONFIG_DESCRIPTOR_REQUEST_LEN, CONTROL_TRANSFER_REPLY_PREFIX,
    CONTROL_TRANSFER_REQUEST_LEN, DEVICE_DESCRIPTOR_REPLY_LEN, DEVICE_DESCRIPTOR_REQUEST_LEN,
    HID_REPORT_MAX, INTERRUPT_IN_REPLY_PREFIX, INTERRUPT_IN_REQUEST_LEN, MAX_PORTS_REPORTED,
