...
use crate::protocol::{
    ...
    OP_QUERY_FOCUS, OP_QUERY_TOPMOST, OP_ROUTE_FOCUS, OP_WINDOW_CLOSE, OP_WINDOW_FOCUS,
...
fn dispatch(
    ...
    match req.op {
        ...
        OP_QUERY_FOCUS if body.is_empty() => handlers::query_focus::handle(ctx, sender_pid, &req, tx),
