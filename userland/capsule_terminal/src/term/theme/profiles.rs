...
pub const DARK: Theme = Theme {
    ...
    dim: 0xFF56_5E69, ok: 0xFF35_D07A, err: 0xFFE5_484D,
    run: 0xFF56_5E69, chrome_edge: 0xFF1A_1F24,
};

pub const DIM: Theme = Theme {
    bg: 0xB00B_0E12, fg: 0xFFE2_E8EF, accent: 0xFF5A_E6D0, path: 0xFF7C_F0A8,
    dim: 0xFF6B_747E, ok: 0xFF35_D07A, err: 0xFFE5_484D,
    run: 0xFF6B_747E, chrome_edge: 0xFF23_2A31,
};

pub const LIGHT: Theme = Theme {
    bg: 0xFFF2_F4F7, fg: 0xFF15_181C, accent: 0xFF0E_7A70, path: 0xFF15_694A,
    dim: 0xFF6A_727C, ok: 0xFF12_784A, err: 0xFFB0_1218,
    run: 0xFF8A_9099, chrome_edge: 0xFFD8_DDE4,
};

pub const ABYSS: Theme = Theme {
    bg: 0xFF00_0308, fg: 0xFFC8_D2DC, accent: 0xFF5A_E6D0, path: 0xFF7C_F0A8,
    dim: 0xFF4A_525B, ok: 0xFF35_D07A, err: 0xFFE5_484D,
    run: 0xFF4A_525B, chrome_edge: 0xFF0A_0E13,
};
