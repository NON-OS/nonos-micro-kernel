...
const COMMANDS: &[&[u8]] = &[
    b"help", b"about", b"version", b"whoami", b"caps", b"capsules", b"clear", b"display", b"echo",
    b"history", b"market", b"motd", b"ping", b"svc", b"service", b"nox", b"exit", b"where", b"pwd",
    b"in", b"cd", b"ls", b"dir", b"read", b"cat", b"write", b"copy", b"cp", b"mk", b"mkdir", b"rm",
    b"del", b"mv", b"move", b"stat", b"id", b"sys", b"apps", b"grep", b"wc", b"head", b"tail",
    b"run", b"open", b"set", b"unset", b"alias", b"unalias", b"sort", b"uniq", b"nl",
];
