...
pub use ops::{
    ...
    OP_SEND_REPLY, OP_SET_AUTHORITY, OP_SET_CREDENTIAL, OP_SET_DESTINATION, OP_SET_GATEWAY,
    OP_SET_IDENTITY, OP_SET_TIMING, OP_SET_TOPOLOGY, OP_SYNC_DIRECTORY, OP_TIMING_STATUS,
    OP_TOPOLOGY_STATUS,
};
