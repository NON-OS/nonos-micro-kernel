...
// `recursive` a directory's whole subtree is copied. Payload is
// `u32 owner_pid, u8 src_len, src, u8 dst_len, dst, u8 recursive`.
pub fn copy(owner_pid: u32, src: &[u8], dst: &[u8], recursive: bool) -> Result<(), &'static str> {
