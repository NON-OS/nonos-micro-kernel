pub fn fill_rect(buf: &mut [u32], spx: usize, w: u32, h: u32, x: u32, y: u32, rw: u32, rh: u32, argb: u32) {
    let x1 = (x + rw).min(w);
...
pub fn gradient_v(buf: &mut [u32], spx: usize, w: u32, h: u32, x: u32, y: u32, rw: u32, rh: u32, top: u32, bot: u32) {
    let den = rh.max(1);
    for row in 0..rh {
