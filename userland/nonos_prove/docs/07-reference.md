...
**Is this zero-knowledge?** Not yet, and the docs do not claim it. prøve produces a
...
terminal, then write a `.prv` file and run `prove myfile.prv`.

## Reproducing the claims

In `userland/nonos_prove_proofs`: `cargo test` runs the 30 host proofs behind this
