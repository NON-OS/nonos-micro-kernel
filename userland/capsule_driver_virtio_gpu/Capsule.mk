...
# CoreExec | IPC | Memory | Debug | DeviceEnum | Driver | Mmio | Irq | Dma | Pio
# = 0x01 | 0x08 | 0x10 | 0x100 | 0x8000 | 0x10000 | 0x20000 | 0x40000 | 0x80000 | 0x100000 = 0x1F8119
# Debug granted while the GPU bring-up is being stabilised; once the
# pixel pipeline is end-to-end verified this drops back to 0x1F8019.
