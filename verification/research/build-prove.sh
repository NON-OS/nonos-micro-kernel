...
out="nonos-prove.docx"

pandoc nonos-prove.md \
  --citeproc --bibliography=prove-references.bib \
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:p>
    ...
    <w:r><w:rPr><w:color w:val="2E5C5C"/><w:sz w:val="16"/></w:rPr><w:t xml:space="preserve">prøve Language   ·   </w:t></w:r>
