...
live results: 57/57 fleet pairing checks, 40/40 enforced runtime
attestations from a 5-contributor external ceremony. These describe today's
artifacts; the contracts must not hardcode them.
