...
pub(super) fn map_block_error(e: BlockDeviceError) -> CryptoBlockError {
    match e {
        BlockDeviceError::AccessDenied | BlockDeviceError::NoCallerPid => {
            CryptoBlockError::AccessDenied
        }
