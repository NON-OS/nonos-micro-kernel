...
use crate::syscall::dispatch::crypto::{
    ...
    handle_crypto_keccak256, handle_crypto_random, handle_crypto_secp256k1_pubkey,
    handle_crypto_secp256k1_sign, handle_hkdf_sha256, handle_hmac_sha256, handle_x25519_public,
