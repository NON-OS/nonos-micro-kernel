...
use super::embed::{
    DRIVER_VIRTIO_BLK_ELF, DRIVER_VIRTIO_BLK_MANIFEST_BYTES, DRIVER_VIRTIO_BLK_ATTESTATION_BYTES, DRIVER_VIRTIO_BLK_NONOS_ID_CERT_BYTES,
};
use super::state;
...
pub fn spawn_driver_virtio_blk_capsule() -> Result<(), SpawnError> {
    ...
    let spec = CapsuleSpecVerified {
        ...
        attestation_trailer: DRIVER_VIRTIO_BLK_ATTESTATION_BYTES,
