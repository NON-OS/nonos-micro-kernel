...
use super::embed::{
    DRIVER_RTL8821CE_ATTESTATION_BYTES, DRIVER_RTL8821CE_ELF, DRIVER_RTL8821CE_MANIFEST_BYTES,
    DRIVER_RTL8821CE_NONOS_ID_CERT_BYTES,
};
use super::state;
...
const SERVICE_NAME: &str = "driver.rtl8821ce0";
...
pub fn spawn_driver_rtl8821ce_capsule() -> Result<(), SpawnError> {
    ...
    let spec = CapsuleSpecVerified {
        ...
        elf: DRIVER_RTL8821CE_ELF,
        nonos_id_cert_bytes: DRIVER_RTL8821CE_NONOS_ID_CERT_BYTES,
        manifest_bytes: DRIVER_RTL8821CE_MANIFEST_BYTES,
        attestation_trailer: DRIVER_RTL8821CE_ATTESTATION_BYTES,
