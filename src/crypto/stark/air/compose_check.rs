...
impl ComposeCheck {
    ...
    pub fn new(
        ...
        ComposeCheck { window, periodic, coeffs, z, comp_z, g_tm1, t, boundaries }
    }
    ...
    fn out_values(&self) -> (Fp2, Fp2, Fp2, Fp2, Fp2) {
        ...
        let (sel0, sel1, id, sig, gp_sel) =
            (self.periodic[0], self.periodic[1], self.periodic[2], self.periodic[3], self.periodic[4]);
