...
use super::embed::RELIBC_TEST_ELF;
#[cfg(not(feature = "nonos-dev-unverified-capsules"))]
use super::embed::{
    RELIBC_TEST_ATTESTATION_BYTES, RELIBC_TEST_MANIFEST_BYTES, RELIBC_TEST_NONOS_ID_CERT_BYTES,
};
...
const SERVICE_NAME: &str = "relibc_test";
const SERVICE_PORT: u32 = 4506;
const REPLY_INBOX: &str = "endpoint.relibc_test.reply";
const REPLY_PORT: u32 = 4507;
#[cfg(not(feature = "nonos-dev-unverified-capsules"))]
...
#[cfg(not(feature = "nonos-dev-unverified-capsules"))]
pub fn spawn_relibc_test_capsule() -> Result<(), SpawnError> {
    ...
    let spec = CapsuleSpecVerified {
        ...
        elf: RELIBC_TEST_ELF,
        nonos_id_cert_bytes: RELIBC_TEST_NONOS_ID_CERT_BYTES,
        manifest_bytes: RELIBC_TEST_MANIFEST_BYTES,
        attestation_trailer: RELIBC_TEST_ATTESTATION_BYTES,
