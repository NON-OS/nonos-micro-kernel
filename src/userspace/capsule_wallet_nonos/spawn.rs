...
use super::embed::{
    WALLET_NONOS_ATTESTATION_BYTES, WALLET_NONOS_ELF, WALLET_NONOS_MANIFEST_BYTES,
    WALLET_NONOS_NONOS_ID_CERT_BYTES,
};
use super::state;
...
pub fn spawn_wallet_nonos_capsule() -> Result<(), SpawnError> {
    ...
    let spec = CapsuleSpecVerified {
        ...
        elf: WALLET_NONOS_ELF,
        nonos_id_cert_bytes: WALLET_NONOS_NONOS_ID_CERT_BYTES,
        manifest_bytes: WALLET_NONOS_MANIFEST_BYTES,
        attestation_trailer: WALLET_NONOS_ATTESTATION_BYTES,
        target_triple: TARGET_TRIPLE,
        requested_caps: Capability::CoreExec.bit()
            | Capability::IPC.bit()
            | Capability::Network.bit()
